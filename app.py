...
st.sidebar.header("🤖 AI Calibration")
st.sidebar.markdown("Define your market outlook to update the Bayesian generative inference engine.")
...
try:
    ...
    with col1:
        st.subheader("AI Asset Allocation")
